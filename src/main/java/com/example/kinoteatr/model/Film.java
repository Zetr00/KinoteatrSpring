...
public class Film {
    ...
    public Film(long id_film, String name_film, int rating_film, double price_film, int year_film, int time_film, Genre genre, Manufacturer manufacturer, Author author, List<Indent> indent) {
